      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">SRDVP</span>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="customer.php">
          ...
          <span>បង្កើត​អតិថិជន</span>
        </a>
        <li class="nav-item">
        <a class="nav-link collapsed" href="suplier.php ">
          <i class="bi bi-person-plus-fill"></i>
          <span>បង្កើតអ្នកផ្គត់ផ្គង់</span>
        </a>
        <li class="nav-item">
        <a class="nav-link collapsed" href="product.php ">
          <i class="bi bi-person-plus-fill"></i>
          <span>ផលិតផល​​​​ទំនិញ</span>
        </a>
        <li class="nav-item">
        <a class="nav-link collapsed" href="category.php">
          <i class="bi bi-box"></i>
          <span>ក្រុមផលិតផល</span>
        </a>
        <li class="nav-item">
        <a class="nav-link collapsed" href="sale.php">
          <i class="bi bi-box"></i>
          <span>បង្កើតការលក់</span>
        </a>
        
        <li class="nav-item">
        <a class="nav-link collapsed" href="#">
          <i class="bi bi-cart-fill"></i>
          <span>ស្តុកទំនិញ</span>
        </a>
        <li class="nav-item">
        <a class="nav-link collapsed" href="#">
